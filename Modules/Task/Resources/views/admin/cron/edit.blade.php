        ...
        <form id="add-form" class="form-horizontal form-ajax card-body" role="form" data-toggle="validator" method="POST" action="">
            ...
            <div class="form-group row curl-form-group">
                ...
                <div class="col-sm-10 row m-0">
                    <select class="form-control col-sm-3 custom-select curl-field" placeholder="请求方式" name="row[curl_method]" id="params_curl_method" style="border-radius:0;" >
                        ...
                        <option value="DELETE" @if($task->curl_params && $task->curl_params['method'] == 'DELETE') selected @endif>DELETE</option>
                        <option value="PATCH">PATCH</option>
                    </select>
                    <input type="text" class="form-control col-sm-9" id="params_curl_url" name="row[curl_url]" placeholder="http://example.com" value="{{$task->curl_url}}" data-rule="required" />
            ...
            <div class="form-group row g-lg-2 g-1">
                ...
                <div class="col-sm-10">
                    ...
                    <label>
                        <input type="radio" name="row[status]" value="2" class="flat-red"  @if($task->status == '2') checked @endif> 关闭
                    </label>
                </div>
            </div>
            <div class="form-group row g-lg-2 g-1">
