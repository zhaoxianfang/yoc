    ...
    <div class="container-fluid topbar-menu">
        ...
        <div class="d-flex align-items-center gap-2">
            ...
            <div class="topbar-item nav-user">
                <div class="dropdown">
                    <a class="topbar-link dropdown-toggle drop-arrow-none px-2" data-bs-toggle="dropdown" data-bs-offset="0,16" href="pages-empty.html#!" aria-haspopup="false" aria-expanded="false">
                        <img src="{{ asset('static/images/system/default_user.png') }}" width="32" class="rounded-circle me-lg-2 d-flex" alt="user-image">
