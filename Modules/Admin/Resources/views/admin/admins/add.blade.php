...
<div class="card card-info">
    <form id="add-form" class="form-horizontal form-ajax card-body" role="form" data-toggle="validator" method="POST" action="">
        ...
        <div class="form-group row g-lg-2 g-1">
            ...
            <div class="col-xs-12 col-sm-8">
                <input type="text" class="form-control" id="mobile" name="row[password]" placeholder="" value="" data-rule="required|strong_pwd" />
        ...
        <div class="form-group row g-lg-2 g-1">
            ...
            <div class="col-xs-12 col-sm-8">
                <label>
                    <input type="radio" name="row[gender]" value="1" class="flat-red" checked> 男
                </label>
                <label>
                    <input type="radio" name="row[gender]" value="2" class="flat-red"> 女
                </label>
            </div>
        </div>
        <div class="border-top border-dashed my-2"></div>
        ...
        <div class="form-group row g-lg-2 g-1">
            ...
            <div class="col-xs-12 col-sm-8">
                <label>
                    <input type="radio" name="row[status]" value="1" class="flat-red" checked> 启用
                </label>
                <label>
                    <input type="radio" name="row[status]" value="2" class="flat-red"> 冻结
                </label>
            </div>
        </div>
        <div class="form-group row g-lg-2 g-1">
