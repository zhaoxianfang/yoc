        ...
        <form id="add-form" class="form-horizontal form-ajax" role="form" data-toggle="validator" method="POST" action="">
            ...
            <div class="card-body row">
                <div class="form-group row g-lg-2 g-1">
                    ...
                    <div class="col-sm-10">
                        <label>
                            <input type="radio" name="row[ismenu]" value="1" class="flat-red" checked>
                            是
                        </label>
                        <label>
                            <input type="radio" name="row[ismenu]" value="0" class="flat-red">
                            否
                        </label>
                    </div>
                </div>
                ...
                <div class="form-group row g-lg-2 g-1">
                    ...
                    <div class="col-sm-10">
                        <input type="text" class="form-control" id="name" name="row[name]" placeholder="控制器名/方法名" value="" data-join="check_name" data-rule="required|remote(/admin/system/config/unique)" />
                    ...
                    <div class="col-sm-10">
                        <div class="input-group input-groupp-md">
                            <div class="input-group">
                                <span class="input-group-text fs-20"><i class="ti ti-alien" id="icon-preview"></i></span>
                                <input type="text" class="form-control" id="icon" name="row[icon]" value="ti ti-alien" placeholder="小图标" />
                ...
                <div class="form-group row g-lg-2 g-1">
                    ...
                    <div class="col-sm-10">
                        <select class="form-control custom-select col-xs-12 col-sm-12" name="row[badge_text_style]" style="border-radius:0px;">
                            <option selected="selected" value="badge-default">&nbsp;&nbsp;(默认)白色</option>
                            <option value="text-bg-primary">&nbsp;&nbsp;主要(primary)</option>
                            <option value="text-bg-secondary">&nbsp;&nbsp;次要(secondary)</option>
                            <option value="text-bg-success">&nbsp;&nbsp;成功(success)</option>
                            <option value="text-bg-danger">&nbsp;&nbsp;危险(danger)</option>
                            <option value="text-bg-warning">&nbsp;&nbsp;警告(warning)</option>
                            <option value="text-bg-info">&nbsp;&nbsp;信息(info)</option>
                            <option value="text-bg-light">&nbsp;&nbsp;明亮(light)</option>
                            <option value="text-bg-dark">&nbsp;&nbsp;黑暗(dark)</option>
                            <option value="text-bg-purple">&nbsp;&nbsp;紫色(purple)</option>
                        </select>
