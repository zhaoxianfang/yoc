            ...
            <form method="post" class="bg-white">
                ...
                <ul class="nav nav-tabs mb-3">
                    ...
                    @foreach ($tabs as $tab)
                        @if (!$loop->first)
                        <li class="nav-item">
                            <a href="#tab-{{ $tab['value']['key'] }}" data-bs-toggle="tab" aria-expanded="@if ($loop->first) true @else false @endif" class="nav-link @if ($loop->first) active @endif">{{ $tab['value']['name'] }}</a>
                        </li>
                        @endif
                    @endforeach
                    <li class="nav-item">
                                    ...
                                    <div class="col-sm-12">
                                        ...
                                        <div class="input-group row mb-3 config-tabs-item" id="config_common_tabs">
                                            ...
                                            <div class="input-group-append col-5 m-0 pl-2">
                                                <button type="button" class="btn btn-outline btn-danger" id="plus_tabs" style="border-radius: 0;"><i class="ti ti-plus"></i></button>
                                                <button type="button" class="btn btn-outline btn-danger trash_tabs" style="border-radius: 0; display: none;"><i class="ti ti-trash"></i></button>
                                            </div>
                                        </div>
                                        ...
                                        <div class="input-group row mb-3 config-tabs-item">
                                            ...
                                            <div class="input-group-append col-5 m-0 pl-2">
                                                <button type="button" class="btn btn-outline btn-danger" style="border-radius: 0;background-color: #fff; color: #ec4758;" disabled><i class="ti ti-trash"></i></button>
                                            </div>
                                        </div>
