        ...
        <form id="add-form" class="form-horizontal form-ajax" role="form" data-toggle="validator" method="POST" action="">
            ...
            <div class="card-body row">
                    ...
                    <div class="col-xs-12 col-sm-8">
                        <select class="form-control select2  col-xs-12 col-sm-12" name="row[pid]" style="border-radius:0px;">
                            ...
                            @foreach ($group_list as $group)
                                <option value="{{ $group['id'] }}" @if ($group['id'] == $info['pid']) selected @endif>{{ $group['group_name'] }}</option>
                            @endforeach
                        </select>
                    </div>
                </div>
                ...
                <div class="form-group row g-lg-2 g-1">
                    ...
                    <div class="col-xs-12 col-sm-8">
                        <input type="text" class="form-control" id="name" name="row[group_name]" placeholder="" value="{{ $info['group_name'] }}" data-rule="required" />
                    </div>
                </div>
                <div class="border-top border-dashed"></div>
                <div class="form-group row g-lg-2 g-1">
                    ...
                    <div class="col-xs-12 col-sm-8 datepicker-date">
                        <div class="input-group m-b date">
                            <input type="text" class="form-control date" name="row[expiration_at]" value="{{ $info['expiration_at'] }}" data-rule="required">
                ...
                <div class="form-group row g-lg-2 g-1">
                    ...
                    <div class="col-xs-12 col-sm-8">
                        <input type="hidden" name="row[rules]" value="{{$info['rules']}}" id="rule_node">
                ...
                <div class="form-group row g-lg-2 g-1">
                    ...
                    <div class="col-xs-12 col-sm-8">
                        <label>
                            <input type="radio" name="row[status]" value="1" class="flat-red" @if ($info->status == 1) checked @endif>
                            启用
                        </label>
                        <label>
                            <input type="radio" name="row[status]" value="0" class="flat-red" @if ($info->status == 0) checked @endif>
                            停用
                        </label>
                    </div>
                </div>
