    ...
    <script>
        $(function () {
            ...
            Table = TableTools.init({
                index_url: '/admin/user/blacklist',
                add_url: "{{ admin_auth('admin/user/blacklist/create','/admin/user/blacklist/create') }}",
                edit_url: "{{ admin_auth('admin/user/blacklist/update','/admin/user/blacklist/{id}/edit') }}",
                del_url: "{{ admin_auth('admin/user/blacklist/delete','/admin/user/blacklist/{id}/delete') }}",
