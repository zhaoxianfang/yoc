                    ...
                    <div class="">
                        <form method="post" class="p-3 unbind-form">
                            ...
                            <div class="form-group row">
                                <div class="col-sm-12"><input type="text" class="form-control" placeholder="手机/邮箱号" name="user_name" value="{{ old("user_name") }}" data-rule="required" /></div>
                            </div>
                            <div class="form-group row">
                            ...
                            <div class="form-group row">
                                <span class="text-right col-sm-12" style="margin: -20px 0 10px 0;">已有账号？<a href="{{ route('docs.auth.login') }}">立即登录</a> </span>
                                <div class="col-sm-12">
                                    <button type="submit" class="btn btn-sm btn-w-m btn-primary width-full">注册</button>
                                </div>
                            </div>
                        </form>
                    </div>
